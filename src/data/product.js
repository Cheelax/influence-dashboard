...
export const getListByCategory = (category) => {
  return Object.values(IDS).filter((i) => TYPES[i].category === category);
};

export const getListByClassification = (classification) => {
  return Object.values(IDS).filter(
    (i) => TYPES[i].classification === classification
  );
};
